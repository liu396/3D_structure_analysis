...
int main()
{
	...
	double ab_x = 3.2274480000000000e+02, ab_y = 3.2273879999999997e+02, ab_z = 3.2279399999999998e+02;
	...
	resY = ydelta / ab_y;
	resZ = zdelta / ab_z;
	#pragma omp parallel for private(tri_l,tri_r,X,Y,Z,i,s,t,v1_x,v1_y,v1_z,v2_x,v2_y,v2_z,n_x,n_y,n_z,cal,pz)
	for (j = 0; j < NATOM; j++)
	{
		X = atom_x[j] * resX + xb;
		Y = atom_y[j] * resY + yb;
